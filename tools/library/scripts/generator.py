...
def GenerateSM75_TensorOp_1688(manifest, args):
  ...
  for math_inst in math_instructions:
    ...
    # Tile descritions without warp_k and tile_k same.

    #tile_descriptions = [
    #  TileDescription([ 32, 32, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 64, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 64, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 96, 32], 2, [  1,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 96, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32,128, 32], 2, [  1,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32,128, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32,128, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    ...
    #  TileDescription([ 64, 64, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 96, 32], 2, [  2,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 96, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 96, 32], 2, [  1,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 96, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 32], 2, [  2,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 32], 2, [  2,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 32], 2, [  1,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 32, 32], 2, [  3,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 32, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 64, 32], 2, [  3,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 64, 32], 2, [  3,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 64, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 64, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 96, 32], 2, [  3,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 96, 32], 2, [  3,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 96, 32], 2, [  1,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 96, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 32], 2, [  3,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 32], 2, [  3,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 32], 2, [  3,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 32], 2, [  1,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 32, 32], 2, [  4,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 32, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 32, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 32], 2, [  4,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 32], 2, [  4,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 32], 2, [  2,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 32], 2, [  4,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 32], 2, [  4,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 32], 2, [  2,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 32], 2, [  1,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  4,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  4,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  4,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  2,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  2,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  1,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  2,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,256, 32], 2, [  2,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,256, 32], 2, [  2,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,256, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,256, 32], 2, [  1,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,256, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,256, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([256,128, 32], 2, [  4,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([256,128, 32], 2, [  4,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([256,128, 32], 2, [  2,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([256,128, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([256,128, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([256,128, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([256,256, 32], 2, [  4,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([256,256, 32], 2, [  4,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([256,256, 32], 2, [  4,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([256,256, 32], 2, [  2,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([256,256, 32], 2, [  2,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([256,256, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([256,256, 32], 2, [  1,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([256,256, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([256,256, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #]
    
    # Descriptions for building with multiple k's and tile dimensions not powers of two.
    
    #tile_descriptions = [
    #  TileDescription([ 32, 32, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 32, 64], 2, [  1,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 32, 64], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 64, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 64, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 64, 64], 2, [  1,  2,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 64, 64], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 64, 64], 2, [  1,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 64, 64], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 96, 32], 2, [  1,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 96, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 96, 64], 2, [  1,  3,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 96, 64], 2, [  1,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 96, 64], 2, [  1,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 32, 96, 64], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32,128, 32], 2, [  1,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32,128, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32,128, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32,128, 64], 2, [  1,  4,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 32,128, 64], 2, [  1,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32,128, 64], 2, [  1,  2,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 32,128, 64], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 32,128, 64], 2, [  1,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 32,128, 64], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 32, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 32, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 32, 64], 2, [  2,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 32, 64], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 32, 64], 2, [  1,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 32, 64], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 64, 32], 2, [  2,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 64, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 64, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 64, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 64, 64], 2, [  2,  2,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 64, 64], 2, [  2,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 64, 64], 2, [  2,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 64, 64], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 64, 64], 2, [  1,  2,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 64, 64], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 64, 64], 2, [  1,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 64, 64], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 96, 32], 2, [  2,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 96, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 96, 32], 2, [  1,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 96, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 96, 64], 2, [  2,  3,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 96, 64], 2, [  2,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 96, 64], 2, [  2,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 96, 64], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 96, 64], 2, [  1,  3,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 96, 64], 2, [  1,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 96, 64], 2, [  1,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 64, 96, 64], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 32], 2, [  2,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 32], 2, [  2,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 32], 2, [  1,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 64], 2, [  2,  4,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 64], 2, [  2,  4,  1], math_inst, min_cc, max_cc),
    ...
    #  TileDescription([ 64,128, 64], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 64], 2, [  1,  4,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 64], 2, [  1,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 64], 2, [  1,  2,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 64], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 64], 2, [  1,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 64,128, 64], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 32, 32], 2, [  3,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 32, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 32, 64], 2, [  3,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 32, 64], 2, [  3,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 32, 64], 2, [  1,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 32, 64], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 64, 32], 2, [  3,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 64, 32], 2, [  3,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 64, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 64, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 64, 64], 2, [  3,  2,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 64, 64], 2, [  3,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 64, 64], 2, [  3,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 64, 64], 2, [  3,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 64, 64], 2, [  1,  2,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 64, 64], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 64, 64], 2, [  1,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 64, 64], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 96, 32], 2, [  3,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 96, 32], 2, [  3,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 96, 32], 2, [  1,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 96, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 96, 64], 2, [  3,  3,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 96, 64], 2, [  3,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 96, 64], 2, [  3,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 96, 64], 2, [  3,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 96, 64], 2, [  1,  3,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 96, 64], 2, [  1,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 96, 64], 2, [  1,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 96, 96, 64], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 32], 2, [  3,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 32], 2, [  3,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 32], 2, [  3,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 32], 2, [  1,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 64], 2, [  3,  4,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 64], 2, [  3,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 64], 2, [  3,  2,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 64], 2, [  3,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 64], 2, [  3,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 64], 2, [  3,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 64], 2, [  1,  4,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 64], 2, [  1,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 64], 2, [  1,  2,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 64], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 64], 2, [  1,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([ 96,128, 64], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 32, 32], 2, [  4,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 32, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 32, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 32, 64], 2, [  4,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128, 32, 64], 2, [  4,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 32, 64], 2, [  2,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128, 32, 64], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 32, 64], 2, [  1,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128, 32, 64], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 32], 2, [  4,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 32], 2, [  4,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 32], 2, [  2,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 64], 2, [  4,  2,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 64], 2, [  4,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 64], 2, [  4,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 64], 2, [  4,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 64], 2, [  2,  2,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 64], 2, [  2,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 64], 2, [  2,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 64], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 64], 2, [  1,  2,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 64], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 64], 2, [  1,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128, 64, 64], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 32], 2, [  4,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 32], 2, [  4,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 32], 2, [  2,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 32], 2, [  1,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 64], 2, [  4,  3,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 64], 2, [  4,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 64], 2, [  4,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 64], 2, [  4,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 64], 2, [  2,  3,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 64], 2, [  2,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 64], 2, [  2,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 64], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 64], 2, [  1,  3,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 64], 2, [  1,  3,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 64], 2, [  1,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128, 96, 64], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  4,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  4,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  4,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  2,  4,  1], math_inst, min_cc, max_cc),
    ...
    #  TileDescription([128,128, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  4,  4,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  4,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  4,  2,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  4,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  4,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  4,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  2,  4,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  2,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  2,  2,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  2,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  2,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  1,  4,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  1,  4,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  1,  2,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  1,  1,  2], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 64], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  2,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  2,  1,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  1,  2,  1], math_inst, min_cc, max_cc),
    #  TileDescription([128,128, 32], 2, [  1,  1,  1], math_inst, min_cc, max_cc),
